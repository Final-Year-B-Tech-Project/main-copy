"""
Fixed HTML email templates for TalentSync (ASCII safe)
"""
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background: #0f172a; color: #ffffff;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; color: #1e293b;">
        ...
        <div style="padding: 40px 30px;">
            ...
            <div style="background: #f8fafc; border-left: 4px solid #3b82f6; padding: 20px; margin: 25px 0; border-radius: 8px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="{interview_link}" style="display: inline-block; background: linear-gradient(135deg, #3b82f6, #06b6d4); color: #ffffff; text-decoration: none; padding: 15px 30px; border-radius: 25px; font-weight: bold; font-size: 16px;">
                    Start Interview Now
                </a>
            </div>
        ...
        <div style="background: #f8fafc; padding: 20px 30px; text-align: center; border-top: 1px solid #e2e8f0;">
            ...
            <p style="margin: 10px 0 0; color: #94a3b8; font-size: 12px;">
                (c) 2024 TalentSync Pro - Revolutionizing Interviews with AI
            </p>
        </div>
    </div>
</body>
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background: #0f172a; color: #ffffff;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; color: #1e293b;">
        <div style="background: linear-gradient(135deg, {score_color}, #06b6d4); padding: 30px; text-align: center;">
            <div style="background: #ffffff; width: 80px; height: 80px; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; font-size: 24px; color: {score_color}; font-weight: bold;">{score_icon}</div>
        ...
        <div style="padding: 40px 30px;">
            ...
            <div style="background: #f8fafc; border-radius: 12px; padding: 25px; margin: 25px 0; text-align: center; border: 2px solid {score_color};">
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background: #0f172a; color: #ffffff;">
    <div style="max-width: 600px; margin: 0 auto; background: #ffffff; color: #1e293b;">
        <div style="background: linear-gradient(135deg, #1e293b, #3b82f6); padding: 30px; text-align: center;">
            <div style="background: #ffffff; width: 60px; height: 60px; border-radius: 50%; margin: 0 auto 20px; display: flex; align-items: center; justify-content: center; font-size: 16px; color: #3b82f6; font-weight: bold;">HR</div>
        ...
        <div style="padding: 40px 30px;">
            ...
            <div style="background: {rec_color}20; border: 2px solid {rec_color}; border-radius: 12px; padding: 25px; margin: 25px 0; text-align: center;">
                <div style="font-size: 18px; margin-bottom: 10px; color: {rec_color}; font-weight: bold;">{rec_icon}</div>
